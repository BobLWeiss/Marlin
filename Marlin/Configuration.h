...
#define STRING_CONFIG_H_AUTHOR "(bweiss, Kossel)" // Who made the changes.
...
#define DELTA_DIAGONAL_ROD 289.0 // mm

// Horizontal offset from middle of printer to smooth rod center.
#define DELTA_SMOOTH_ROD_OFFSET 209.5 // mm
...
//from FOPDT model - kp=.39 Tp=405 Tdead=66, Tc set to 79.2, aggressive factor of .15 (vs .1, 1, 10)
    #define  DEFAULT_bedKp 22.58
    #define  DEFAULT_bedKi 9.59
    #define  DEFAULT_bedKd 13.35
