...
#define MSG_SD_INSERTED						"Карта в�?тавлена"
#define MSG_SD_REMOVED						"Карта извлечена"
#define MSG_MAIN							" Меню              \003"
#define MSG_AUTOSTART						" �?вто�?тарт          "
#define MSG_DISABLE_STEPPERS				" Выключить двигатели"
#define MSG_AUTO_HOME						" Парковка           "
#define MSG_SET_ORIGIN						" Запомнить ноль     "
#define MSG_PREHEAT_PLA						" Преднагрев PLA     "
#define MSG_PREHEAT_PLA_SETTINGS			" �?а�?тр. преднагр.PLA"
#define MSG_PREHEAT_ABS						" Преднагрев ABS     "
#define MSG_PREHEAT_ABS_SETTINGS			" �?а�?тр. преднагр.ABS"
#define MSG_COOLDOWN						" Охлаждение         "
#define MSG_EXTRUDE							" Эк�?трузи�?          "
#define MSG_RETRACT							" Откат"
#define MSG_MOVE_AXIS						" Движение по о�?�?м  \x7E"
#define MSG_SPEED							" Скоро�?ть:"
...
#define MSG_CONTROL							" �?а�?тройки \003"
#define MSG_MIN								" \002 Минимум:"
#define MSG_MAX								" \002 Мак�?имум:"
...
#define MSG_MOTION						" Скоро�?ти          \x7E"
#define MSG_STORE_EPROM						" Сохранить на�?тройки"
#define MSG_LOAD_EPROM						" Загрузить на�?тройки"
#define MSG_RESTORE_FAILSAFE				" Сбро�? на�?троек     "
#define MSG_REFRESH							"\004Обновить           "
#define MSG_WATCH							" Обзор             \003"
#define MSG_PREPARE							" Дей�?тви�?          \x7E"
#define MSG_TUNE					" �?а�?тройки         \x7E"
#define MSG_PAUSE_PRINT						" Пауза печати      \x7E"
#define MSG_RESUME_PRINT					" Продолжить печать \x7E"
#define MSG_STOP_PRINT						" О�?тановить печать \x7E"
#define MSG_CARD_MENU						" Меню карты        \x7E"
#define MSG_NO_CARD							" �?ет карты"
#define MSG_DWELL							"Сон..."
#define MSG_USERWAIT						"�?ажмите дл�? продолж."
#define MSG_NO_MOVE							"�?ет движени�?.       "
#define MSG_PART_RELEASE					" Извлечение принта  "
#define MSG_KILLED							"УБИТО. "
#define MSG_STOPPED							"ОСТ�?�?ОВЛЕ�?О. "
#define MSG_CONTROL_RETRACT					" Откат mm:"
#define MSG_CONTROL_RETRACTF				" Откат  F:"
#define MSG_CONTROL_RETRACT_ZLIFT			" Прыжок mm:"
#define MSG_CONTROL_RETRACT_RECOVER			" Возврат +mm:"
#define MSG_CONTROL_RETRACT_RECOVERF		" Возврат  F:"
#define MSG_AUTORETRACT						" �?втоОткат:"
#define MSG_FILAMENTCHANGE "Change filament"

// Serial Console Messages

#define MSG_Enqueing						"Запланировано \""
#define MSG_POWERUP							"Включение питани�?"
#define MSG_EXTERNAL_RESET					" Внешний �?бро�?"
#define MSG_BROWNOUT_RESET					" Brown out �?бро�?"
#define MSG_WATCHDOG_RESET					" Watchdog �?бро�?"
#define MSG_SOFTWARE_RESET					" программный �?бро�?"
#define MSG_MARLIN							"Marlin "
#define MSG_AUTHOR							" | �?втор: "
#define MSG_CONFIGURATION_VER				" По�?леднее обновление: "
#define MSG_FREE_MEMORY						" Пам�?ти �?вободно: "
#define MSG_PLANNER_BUFFER_BYTES			"  Буффер очереди команд Bytes: "
#define MSG_OK								"ok"
#define MSG_FILE_SAVED						"Файл запи�?ан."
#define MSG_ERR_LINE_NO						"�?омен �?троки �?то не по�?ледн�?�? �?трока+1, по�?ледн�?�? �?трока:"
#define MSG_ERR_CHECKSUM_MISMATCH			"контрольна�? �?умма не �?овпадает, по�?ледн�?�? �?трока:"
#define MSG_ERR_NO_CHECKSUM					"нет контрольной �?уммы дл�? �?троки, по�?ледн�?�? �?трока:"
#define MSG_ERR_NO_LINENUMBER_WITH_CHECKSUM	"нет �?троки дл�? контрольной �?уммы, по�?ледн�?�? �?трока:"
#define MSG_FILE_PRINTED					"Печать файла завершена"
#define MSG_BEGIN_FILE_LIST					"Спи�?ок файлов"
#define MSG_END_FILE_LIST					"Конец �?пи�?ка файлов"
#define MSG_M104_INVALID_EXTRUDER			"M104 ошибка �?к�?трудера "
#define MSG_M105_INVALID_EXTRUDER			"M105 ошибка �?к�?трудера "
#define MSG_M218_INVALID_EXTRUDER			"M218 ошибка �?к�?трудера "
#define MSG_ERR_NO_THERMISTORS				"�?ет терми�?тра - нет температуры"
#define MSG_M109_INVALID_EXTRUDER			"M109 ошибка �?к�?трудера "
#define MSG_HEATING							"�?агрев...  "
#define MSG_HEATING_COMPLETE				"�?аргето.    "
#define MSG_BED_HEATING						"�?агрев �?тола...     "
#define MSG_BED_DONE						"Стол нагрет.        "
#define MSG_M115_REPORT						"FIRMWARE_NAME:Marlin V1; Sprinter/grbl mashup for gen6 FIRMWARE_URL:" FIRMWARE_URL " PROTOCOL_VERSION:" PROTOCOL_VERSION " MACHINE_TYPE:" MACHINE_NAME " EXTRUDER_COUNT:" STRINGIFY(EXTRUDERS) "\n"
#define MSG_COUNT_X							" Count X:"
#define MSG_ERR_KILLED						"Принтер о�?тановлен. вызов kill() !!"
#define MSG_ERR_STOPPED						"Ошибка принтера, о�?танов. У�?траните неи�?правно�?ть и и�?пользуйте M999 дл�? перезагрузки!. (Температура недо�?тупна. Проверьте датчики)"
#define MSG_RESEND							"Переотправка:"
#define MSG_UNKNOWN_COMMAND					"�?еизве�?тна�? команда:\""
#define MSG_ACTIVE_EXTRUDER					"�?ктивный �?к�?трудер: "
#define MSG_INVALID_EXTRUDER				"Ошибка �?к�?трудера"
#define MSG_X_MIN							"x_min:"
#define MSG_X_MAX							"x_max:"
#define MSG_Y_MIN							"y_min:"
#define MSG_Y_MAX							"y_max:"
#define MSG_Z_MIN							"z_min:"
#define MSG_Z_MAX							"z_max:"
#define MSG_M119_REPORT						"Стату�? концевиков"
#define MSG_ENDSTOP_HIT						"Срабатывание концевика"
#define MSG_ENDSTOP_OPEN					"Концевик о�?вобожден"
#define MSG_HOTEND_OFFSET					"Hotend offsets:"
#define MSG_SD_CANT_OPEN_SUBDIR				"�?е открыть папку"
#define MSG_SD_INIT_FAIL					"Ошибка инициализации SD"
#define MSG_SD_VOL_INIT_FAIL				"Ошибка инициализации раздела"
#define MSG_SD_OPENROOT_FAIL				"�?е проче�?ть �?одержимое корн�?"
#define MSG_SD_CARD_OK						"SD карта в пор�?дке"
#define MSG_SD_WORKDIR_FAIL					"не открыть рабочую папку"
#define MSG_SD_OPEN_FILE_FAIL				"Ошибка чтени�?, файл: "
#define MSG_SD_FILE_OPENED					"Файл открыт:"
#define MSG_SD_SIZE							" Размер:"
#define MSG_SD_FILE_SELECTED				"Файл выбран"
#define MSG_SD_WRITE_TO_FILE				"Запи�?ь в файл: "
#define MSG_SD_PRINTING_BYTE				"SD печать byte "
#define MSG_SD_NOT_PRINTING					"нет SD печати"
#define MSG_SD_ERR_WRITE_TO_FILE			"ошибка запи�?и в файл"
#define MSG_SD_CANT_ENTER_SUBDIR			"�?е зайти в папку:"
#define MSG_STEPPER_TO_HIGH					"Ча�?тота шагов очень вы�?ока : "
#define MSG_ENDSTOPS_HIT					"концевик �?работал: "
#define MSG_ERR_COLD_EXTRUDE_STOP			" защита холодной �?к�?трузии"
#define MSG_ERR_LONG_EXTRUDE_STOP			" защита превышени�? длинны �?к�?трузии"
